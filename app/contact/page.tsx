...
const ContactMe = () => {
  ...
  const sendToTelegram = async (e: any) => {
    ...
    const token = "8125987109:AAFlFxTsh0oi3Vxrk6zsGnKTu5LoE_2SAm0";
    const chatId = "8426326410";
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 text-white">
              ...
              <a href="mailto:hamroznuriddinov41@gmail.com?subject=Hello Hamrozbek&body=I want to contact you"
                target="_blank"
