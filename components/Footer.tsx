const Footer = () => {
    return (
        <footer className="bg-[#0f1524] text-gray-300 py-6">
            <div className="containers flex flex-col md:flex-row justify-between">

                {/* Chap qism: copyright + social */}
                <div className="mb-4 md:mb-0">
                    <p className="mb-2 text-[16px]">@2025 Nuriddinov Hamrozbek</p>
